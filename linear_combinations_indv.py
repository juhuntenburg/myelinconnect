...
t1_file = '/scr/ilz3/myelinconnect/new_groupavg/t1/smooth_3/%s_t1_groupdata_smooth_3.npy'
model_file = '/scr/ilz3/myelinconnect/new_groupavg/model/linear_combination/t1indv/%s_t1avg_by_fc_maps_%s.pkl'

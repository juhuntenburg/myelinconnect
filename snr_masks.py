...
for hemi in hemis:
    ...
    for sub in subjects: 
        ...
        #inv2prob_highres_v, inv2prob_highres_f, inv2prob_highres_d = read_vtk(inv2prob_highres_file)
        
        # average across highres vertices that map to the same lowres vertex
        #inv2prob[:,inv2prob_count] = sample_simple(inv2prob_highres_d, labels)
    ...
    #np.save(inv2prob_file, np.min(inv2prob, axis=1))
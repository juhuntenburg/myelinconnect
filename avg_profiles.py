...
pro_file = '/scr/ilz3/myelinconnect/all_data_on_simple_surf/t1/%s_%s_profiles_smooth_3.npy'

#mean_pro_file = '/scr/ilz3/myelinconnect/all_data_on_simple_surf/t1/%s_%s_profiles_mean_3_7.npy'
avg_pro_file = '/scr/ilz3/myelinconnect/all_data_on_simple_surf/t1/avg_%s_profiles_smooth_3.npy'
...
for hemi in hemis:
    ...
    get_size = np.load('/scr/ilz3/myelinconnect/all_data_on_simple_surf/t1/%s_%s_profiles_smooth_3.npy'%(subjects[0], hemi)).shape
